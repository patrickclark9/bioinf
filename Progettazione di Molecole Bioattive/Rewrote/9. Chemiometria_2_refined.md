...
Si plottano i valori di K contro il **TSS** (total sum of within-cluster square distances), individuando il "gomito" della curva (_elbow method_).
...
Gli algoritmi genetici sono algoritmi evoluzionistici che emulano i processi biologici di ricombinazione genetica, mutazione e selezione per generare possibili soluzioni. Sono metodi di ottimizzazione stocastica, caratterizzati dalla capacità di esplorare diverse regioni dello spazio parametrico.
