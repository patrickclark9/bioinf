...
I mesosomi sono invaginazioni nella membrana plasmatica che intervengono nei diversi processi riproduttivi e metabolici. Necessari nei procarioti poichè non presente mitocondri, cloroplasti ecc....
I mesosomi possono essere:
- Settali -> Partecipano alla formazione di setti durante il processo di divisione della cellula
...
## Flagelli
Alcuni batteri sono dotati di una appendica chiamata flagello, responsabile per il movimento e l'adesione. Numero ed organizzazione sono variabili.
I flagelli sono formati da una proteina motrice detta flagellina.
La flagellina fa ruotare il flagello attorno al proprio asse, come un elica, facendo avanzare la cellula.
![[Screenshot 2025-01-02 at 10.55.19.png | 450]]
Il flagello guida il batterio in una data direzione risponendo a stimoli esterni chimici o luminosi (chemiotassi o fototassi).
I batteri si muovo a velocità elevate di circa 50micron/sec..
Percorrono uno spazio di circa 25 volte superiore alle loro dimensioni.
...
La duplicazione del DNA batterico incomincia al centro della cellula nella membrana plasmatica. Il DNA cromosomico si duplica quando la cellula cresce e si distribuisce ai due poli della cellula batterica, la quale si allunga e alla fine si divide in due cellule figlie identiche alla cellula madre. Dopo la duplicazione, il DNA segrega e la cellula inizia a dividersi. Quando da una cellula se ne sono formate due, la citodieresi è completa e si hanno 2 cellule perfettamente identiche.


I fattori esterni che causano l'inizio della riproduzione sono costituiti dalle condizioni ambientali e nutrizionali in cui si trova la cellula. Sebbene in laboratorio è possibile riprodurre perfettamente l'andamento del sistema chiuso, in natura le condizioni ambientali sono soggette a fluttuazioni continue che influenzano il processo di divisione.

(Il nucleoide è spesso associato ai mesosomi ????).

I batteri sono aploidi (hanno n cromosomi) -> singola copia.
I plasmidi sono piccole molecole di DNA 1-150kbp circolare extra cromosomiche che si replicano nella cellula in maniera indipendente contemporanea o meno al genoma batterico.
Contengono pochi geni non indispensabili per la sopravvivenza della cellula, ma che migliorano la cellula. Il corredo plasmidico varia in base al batterio.
Possono essere liberi o integrati nel cromosoma batterico
- Sintesi di pili coniugativi
- Antibiotico Resistenza
- Capacità metaboliche specifiche

I batteri acquisiscono nuove caratteristiche genetiche unicamente tramite le mutazioni.
![[Screenshot 2025-01-02 at 17.24.25.png]]
Le mutazioni comportano modifiche al corredo genomico del batterio:
- A valenza positiva -> migliorano la "fitness" del batterio -> capacità di potersi adattare a differenti ambienti

Il tasso di mutazione, in seguti a tutti i meccanismi di controllo (meccanismi di proofreading) in Polimerasi I II  IV V, è pari a $1 \cdot 10^9$ basi duplicate.
In E. Coli, il tasso di mutazione in Polimerasi III è pari a $1 \cdot 10^5$.
### Citodieresi
La citodieresi consiste nella formazione di un setto trasversale (invaginazione) al centro della cellula.
Questo processo avviene contemporaneamente alla segregazione dei cromosomi.
Il processo di invaginazione viene diviso in più fasi:
1. Selezione del sito dove verrà costruito il setto (punto mediano cellula)
2. Assemblaggio struttura specializzata detta anello Z che divide in due la cellula
